...
namespace DayNightFix {
	...
	public static class TextEncoding
	{
		...
		public static System.Text.Encoding GetSystemEncodingFromFile(string File, System.Text.Encoding DefaultEncoding = null)
		{
			...
			{
				if (!(e is ArgumentException || e is NotSupportedException)) throw;
		...
		{
			return GetSystemEncodingFromFile(Path.Combine(Folder, File), DefaultEncoding);
		}
		...
		{
			return GetEncodingFromFile(Path.Combine(Folder, File));
		}
